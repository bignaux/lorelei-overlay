...
[[ ${PN} = *-gtk-bin ]] && SRC_URI="http://peazip.googlecode.com/files/${MY_P}.LINUX.GTK2.tgz" || \
	SRC_URI="mirror://sourceforge/project/${MY_PN}/${PV}/${MY_P}.LINUX.Qt.tgz"
...
src_install() {
	...
	mv "${S}"/usr/local/share/PeaZip/FreeDesktop_integration/peazip.desktop usr/share/applications/ || die
